...
/**
 * Servlet implementation class followregister
 */
@WebServlet("/followregister")
public class followregister extends HttpServlet {
			...
			//file encrypted and store into filepath1
		     ...
		     filepath1 = editpath + "\\startupinvestment\\WebContent\\Encrypt\\"+filename;
		      ...
		      //file decrypted and store into filepath2
					...
					followerregbean fr=new followerregbean();

					fr.setFolloname(paramValues.get(0).toString());
					System.out.println("name: " + paramValues.get(0));

					fr.setFolloemail(paramValues.get(2).toString());
					System.out.println("email: " + paramValues.get(2));

					fr.setFollonumber(paramValues.get(4).toString());
					System.out.println("number: " + paramValues.get(4));

					fr.setFollopass(paramValues.get(6).toString());
					System.out.println("type: " + paramValues.get(6));
          
					fr.setFollocpass(paramValues.get(8).toString());
					System.out.println("pass: " + paramValues.get(8));
       
					fr.setFilename(filename);
					System.out.println("Filename: " + filename);

					String email = (String) paramValues.get(2);
					...
					try {
						...
						PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM investment.followreg f");
