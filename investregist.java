...
/**
 * Servlet implementation class investregist
 */
@WebServlet("/investregist")
public class investregist extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		investregbean ir = new investregbean();

		ir.setInvestname(paramValues.get(0).toString());
		System.out.println("name: " + paramValues.get(0));

		ir.setInvestemail(paramValues.get(2).toString());
		System.out.println("email: " + paramValues.get(2));

		ir.setInvestnumber(paramValues.get(4).toString());
		System.out.println("number: " + paramValues.get(4));

		ir.setInvestortype(paramValues.get(6).toString());
		System.out.println("type: " + paramValues.get(6));

		ir.setInvestpassword(paramValues.get(8).toString());
		System.out.println("pass: " + paramValues.get(8));

		ir.setInvestcpassword(paramValues.get(10).toString());
		System.out.println("cpass: " + paramValues.get(10));

		ir.setFilename(filename);
		System.out.println("Filename: " + filename);

		email = (String) paramValues.get(2);
		...
		try {
			...
			PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM investment.investreg i");
			...
			if (vemail.equals(paramValues.get(2))) {
				response.sendRedirect("alreadyregistered.jsp");

			} else {

				Inter in = new Imple();
				int i = in.investreg(ir);
				if (i == 1) {
